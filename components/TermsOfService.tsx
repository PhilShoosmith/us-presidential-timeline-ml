    ...
    <div className="w-full min-h-screen bg-slate-900 text-slate-300 p-8 pt-24 overflow-y-auto">
      <div className="max-w-3xl mx-auto bg-slate-800/80 backdrop-blur-md rounded-2xl shadow-2xl border border-slate-700 p-8 animate-fade-in-up">
        <div className="flex justify-between items-center mb-6">
            <h1 className="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-500">{t('terms.title')}</h1>
        ...
        <div className="space-y-4 text-sm leading-relaxed">
           ...
           <h2 className="text-xl font-bold text-yellow-400 mt-6 mb-2">{t('terms.h1')}</h2>
           <p>{t('terms.p2')}</p>

           <h2 className="text-xl font-bold text-yellow-400 mt-6 mb-2">{t('terms.h2')}</h2>
           <p>{t('terms.p3')}</p>
           
           <h2 className="text-xl font-bold text-yellow-400 mt-6 mb-2">{t('terms.h3')}</h2>
           <p>{t('terms.p4')}</p>

           <h2 className="text-xl font-bold text-yellow-400 mt-6 mb-2">{t('terms.h4')}</h2>
           <p>{t('terms.p5')}</p>
        </div>
